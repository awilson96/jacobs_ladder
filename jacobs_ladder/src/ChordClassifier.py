...
CHORD_TEMPLATES_7 = {
    ...
    "Harmonic Major(no7) b2 Bebop":             [1,1,2,1,2,1,4],
    "Major Scale(no7) b2 Bebop":                [1,1,2,1,2,2,3],
    "Major Scale(no3) #5 Bebop":                [2,3,2,1,1,2,1],
    "Harmonic Major #2 Bebop":                  [3,1,1,2,1,3,1],
    "Melodic Minor(add b6) Bebop(no2)":         [3,2,2,1,1,2,1],
    "Major(add b6) Bebop(no2)":                 [4,1,2,1,1,2,1],
    ...
    "Harmonic Minor #4 Bebop":                  [2,1,3,1,1,3,1],
