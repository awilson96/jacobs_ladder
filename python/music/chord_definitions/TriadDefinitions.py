...
class TriadDefinitions:
    ...
    def __init__(self):
        ...
        self.mush = self.determine_valid_interval_sets(intervals=[1, 1])
        self.maj79 = self.determine_valid_interval_sets(intervals=[[2, 9], [11, 3]])
        self.maj79_1st_inv = self.determine_valid_interval_sets(intervals=[9, 1])
        self.maj79_2nd_inv = self.determine_valid_interval_sets(intervals=[1, 2])
