...
class TriadDefinitions:
    ...
    def __init__(self):
        ...
        self.mush = self.determine_valid_interval_sets(intervals=[[1, 1], [1, 10], [10, 1], [11, 2]])
        ...
        self.min7_no5 = self.determine_valid_interval_sets(intervals=[3, 7])
        self.sus56 = self.determine_valid_interval_sets(intervals=[7, 2])
